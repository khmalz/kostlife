...
import { hashPasswordWithSalt, verifyPasswordWithSalt } from "@/lib/crypto";
import {
    addDocument,
    getDocument,
    queryDocuments,
...
export const registerUser = async (
    ...
    try {
        ...
        const existingUsers = await queryDocuments<User>("users", [
        ...
        return { success: false, error: "Registration gagal" };
    }
};
...
export const updateUserBudget = async (
    ...
    try {
        ...
        return { success: false, error: "Gagal memperbarui budget" };
    }
};
...
export const refreshUserSession = async (): Promise<{
    ...
    try {
        ...
        return { success: false, error: "Gagal menyegarkan sesi" };
    }
};
